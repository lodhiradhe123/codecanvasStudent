    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-100 to-white p-6">
      ...
      <Breadcrumb className="mt-6 text-gray-700">
        ...
        <Breadcrumb.Item>
          <span
            className="cursor-pointer hover:text-indigo-500 transition"
            onClick={() => navigate("/dashboard/freetrial")}
          >
            freetrial
          </span>
        </Breadcrumb.Item>
      ...
      <motion.div
        ...
        className="mt-10 bg-gradient-to-r from-purple-100 to-purple-300 shadow-lg rounded-xl p-6 text-center text-white transition-all duration-300 hover:shadow-2xl"
      >
        <Title level={4} className="text-white">
          🎉 Start Your Free Trial Today!
        </Title>
        <Text className="text-gray-200">
          Get 7 days of full access to all premium courses for free. No credit
          card required!
        </Text>
        <Button
          type="default"
          className="mt-4 bg-white text-purple-700 hover:bg-gray-100 w-full"
